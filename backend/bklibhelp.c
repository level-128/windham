   ...
   if (! the_3rd_argv) {
      ...
      printf(
         HELP(
          ...
          "\t                            exclusive with --dry-run.\n"
            ...
            "\t--aux-exec:                 execute SHELL aux entries after unlock. Without\n"
            "\t                             this flag they are only printed as skipped.\n"
      ...
      printf(
         HELP(
            ...
            "\t--aux-exec:                with --aux-probe: execute SHELL entries after\n"
            "\t                             listing them (each command is printed first).\n"
            "\n"
