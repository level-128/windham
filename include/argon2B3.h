...
#define ARGON2B3_CLEAR_INTERNAL_MEMORY (UINT32_C(0))
...
typedef enum Argon2_ErrorCodes {
    ...
    ARGON2B3_OUTPUT_PTR_NULL = -1,

    ARGON2B3_OUTPUT_TOO_SHORT = -2,
    ARGON2B3_OUTPUT_TOO_LONG = -3,

    ARGON2B3_PWD_TOO_SHORT = -4,
    ARGON2B3_PWD_TOO_LONG = -5,

    ARGON2B3_SALT_TOO_SHORT = -6,
    ARGON2B3_SALT_TOO_LONG = -7,

    ARGON2B3_AD_TOO_SHORT = -8,
    ARGON2B3_AD_TOO_LONG = -9,

    ARGON2B3_SECRET_TOO_SHORT = -10,
    ARGON2B3_SECRET_TOO_LONG = -11,

    ARGON2B3_TIME_TOO_SMALL = -12,
    ARGON2B3_TIME_TOO_LARGE = -13,

    ARGON2B3_MEMORY_TOO_LITTLE = -14,
    ARGON2B3_MEMORY_TOO_MUCH = -15,

    ARGON2B3_LANES_TOO_FEW = -16,
    ARGON2B3_LANES_TOO_MANY = -17,

    ARGON2B3_PWD_PTR_MISMATCH = -18,    /* NULL ptr with non-zero length */
    ...
    ARGON2B3_MEMORY_ALLOCATION_ERROR = -22,
	 
	 ARGON2B3_MEMORY_LOCK_ERROR = -23,
	 
    ARGON2B3_INCORRECT_TYPE = -26,

    ARGON2B3_OUT_PTR_MISMATCH = -27,

    ARGON2B3_THREADS_TOO_FEW = -28,
    ARGON2B3_THREADS_TOO_MANY = -29,

    ARGON2B3_MISSING_ARGS = -30,

    ARGON2B3_THREAD_FAIL = -31,
} argon2_error_codes;
...
typedef enum Argon2_version {
    ARGON2B3_VERSION_10 = 0x10,
    ARGON2B3_VERSION_13 = 0x13,
	ARGON2B3_VERSION_1 = 0x100,
    ARGON2B3_VERSION_NUMBER = ARGON2B3_VERSION_1
} argon2_version;
