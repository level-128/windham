...
Windham is free and open-source software for disk encryption, based on the Linux dm-crypt module. It features a high 
entropy header that is indistinguishable from a piece of data of the same size generated by a cryptographically secure 
pseudo-random number generator.

#### This software is in the pre-alpha stage. Use it only for evaluation purposes.
