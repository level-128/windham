...
var I18N = {
  ...
  'zh-CN': {
    ...
    'Master key (no KDF)': '主密钥（免 KDF）',
    'backup_cred_help': '密码备份：完整保存密码密钥槽，恢复时用密码或主密钥均可，且恢复后仍可用密码解锁；创建时需跑一遍 KDF，较慢。主密钥备份：仅保存头部元数据（密钥槽区域为随机填充），只能用主密钥恢复，恢复后只能用主密钥解锁；免 KDF，瞬时完成。',
    'Preparing download...': '正在准备下载...',
    'Download complete.': '下载完成。',
    'No master key available. Re-open the disk first.': '没有可用主密钥。请先重新打开磁盘。',
